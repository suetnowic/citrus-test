...
if ($arResult["FORM_TYPE"] == "login") { ?>
        ...
        <ul>
            <li class="att popup-wrap">
                ...
                <form class="frm-login popup-block" name="system_auth_form<?= $arResult["RND"] ?>" method="post"
                    ...
                    <div class="frm-row">
                        <a href="<?= $arParams["FORGOT_PASSWORD_URL"] ?>"
    ...
    <nav class="menu-block">
        <ul>
            <li>
                <?= $USER->GetFullName() ?>
                <a href="<?= $arParams["PROFILE_URL"] ?>">[<?= $USER->GetLogin() ?>]</a>
            </li>
            <li>
                <a href="?logout=yes&sessid=<?= $_SESSION["fixed_session_id"] ?>"><?= GetMessage("AUTH_LOGOUT_BUTTON") ?></a>
            </li>
        </ul>
    </nav>
<?php }
